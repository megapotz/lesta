...
- **Две роли пользователей:** Система рассчитана только на двух внутренних пользователей: `Маркетинг-менеджер` и `CMO`.
...
*   **Общие поля (для всех типов):**
    ...
    *   `Тип` (текстовое, из справочника: `Юридическое лицо`, `ИП`, `Самозанятый`, `Агентство`)
...
- **Таблица "Список Кампаний":**
    - **Колонки:**
        ...
        - `Продукт`
        - `Статус`
        - `Публикации` (счетчик размещений, факт/план, напр. "15/20")
        - `Расход` (факт/план, напр. "80 000 / 100 000 ₽")
    - **Действия в строке:**
        - `Редактировать` (иконка)

### 7.3. Окно "Создание/Редактирование Кампании"
