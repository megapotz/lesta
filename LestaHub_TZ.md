...
**Описание:** Юридическое или физическое лицо, ответственное за финансовые и организационные обязательства.
**Поля:**
- `ID` (числовое, автоинкремент, первичный ключ)
- `Название` (текстовое, обязательное)
- `Тип` (текстовое, из справочника: `Прямой контракт`, `Агентство`, `CPA-сеть`)
- `ИНН` (числовое)
- `payment_details` (длинный текст, необязательное) - *Задел для будущих прямых выплат.*
